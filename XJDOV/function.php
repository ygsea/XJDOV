 ...
 */
 function zazhi_top(){
 	?>
 	<section class="mzazhi focusbox-wrapper container"><div class="focusbox"><div id="homeslider" class="carousel slide" data-ride="carousel"><ol class="carousel-indicators"><li data-target="#homeslider" data-slide-to="0" class=""></li><li data-target="#homeslider" data-slide-to="1" class="active"></li><li data-target="#homeslider" data-slide-to="2" class=""></li></ol><div class="carousel-inner" role="listbox"><div class="item"><a target="_blank" href="http://ys.www.xjdog.cn"><img src="http://wangpeng4876-1252433523.cosgz.myqcloud.com/%E5%9B%BE%E7%89%87/jxz.jpg" alt="小俊博客 www.xjdog.cn"></a></div><div class="item active"><a target="_blank" href="http://www.xjdog.cn/post/25"><img src="http://wangpeng4876-1252433523.cosgz.myqcloud.com/%E5%9B%BE%E7%89%87/yl.png" alt="小俊博客 www.xjdog.cn"></a></div><div class="item"><a target="_blank" href="http://ys.www.xjdog.cn"><img src="http://wangpeng4876-1252433523.cosgz.myqcloud.com/%E5%9B%BE%E7%89%87/jxz.jpg" alt="小俊博客 www.xjdog.cn"></a></div></div><a class="left carousel-control" href="#homeslider" role="button" data-slide="prev"><i class="fa fa-angle-left"></i></a><a class="right carousel-control" href="#homeslider" role="button" data-slide="next"><i class="fa fa-angle-right"></i></a></div><div class="focusmo"><ul>
 			<li><span><a href="http://127.0.0.1/src/?post=14"> <img src="http://127.0.0.1/src/content/templates/XJDOV/images/random/1.jpg" alt="" class="thumb"><span><h4>Emlog大前端3.0评论头像显示不正常及解决办法</h4></span></a></span></li> 
 			<li><span><a href="http://127.0.0.1/src/?post=8"> <img src="http://127.0.0.1/src/content/templates/XJDOV/images/random/2.jpg" alt="" class="thumb"><span><h4>决定开放版权了</h4></span></a></span></li> 
 		</ul></div><div style="clear:both"></div>
 	 <div class="most-comment-posts"><h3 class="widget_titx"><strong>推荐</strong></h3><ul> 	
 		<li class="item-1"><span class="label label-1">1</span><span id="date">[03-23]</span><a href="http://127.0.0.1/src/?post=14" title="XJDOV1.0.1评论头像显示不正常及解决办法">Emlog大前端3.0评论头像显示不正常及解决办法</a></li>
 		...
 		<li class="item-4"><span class="label label-4">4</span><span id="date">[03-23]</span><a href="http://127.0.0.1/src/?post=13" title="XJDOV开始更新1.0.1">emlog大前端开始更新4.0</a></li>
 		 	
 		<li class="item-5"><span class="label label-5">5</span><span id="date">[03-18]</span><a href="http://127.0.0.1/src/?post=10" title="XJDOV1.0.1解密JS">Emlog大前端 3.0 解密JS</a></li>
 		...
 		<li class="item-7"><span class="label label-7">7</span><span id="date">[05-02]</span><a href="http://127.0.0.1/src/?post=56" title="XJDOV1.0.1">Emlog大前端4.1</a></li>
 		 	
 		<li class="item-8"><span class="label label-8">8</span><span id="date">[04-03]</span><a href="http://127.0.0.1/src/?post=16" title="XJDOV1.0.1修复版">emlog大前端3.0修复版</a></li>
 		 	
 		<li class="item-9"><span class="label label-9">9</span><span id="date">[03-19]</span><a href="http://127.0.0.1/src/?post=11" title="EmlogXJDOV1.0.1主题网站访问不正常及解决方法">Emlog大前端主题网站访问不正常及解决方法</a></li>
...
<section class="focusbox-wrapper container"><div class="focusbox"><div class="focusmo"><ul>
<?php
$index_newlognum = 5;
$db = MySql::getInstance();
if($mm_cms_pci==1){
...
while($row = $db->fetch_array($sql)){$i++;
	...
	<?php }?></ul></div> <div class="most-comment-posts"><h3 class="widget_titx"><center></center></h3><ul><?php
	$db = MySql::getInstance();
	$hot_num = 9;
