...
<?php foreach ($data as $key => $value):
		...
		<a class="first-pic-title" href="http://www.xjdog.cn" title="<?php echo $value["title"]; ?>" target="_blank"><?php echo $value["title"]; ?></a><p class="summary"><?php echo tool_purecontent($value["content"],80); ?></p>
		</li>
		<?php else: ?>
...
<div class="row-fluid">
<div class="widget widget_cms"><div class="span_zahi span2"><span class="icon"><i class="fa fa fa-link"></i></span><h3>友情链接</h3>
