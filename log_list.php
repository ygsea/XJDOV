...
if(isset($_COOKIE["XJDOV_mothod"])){
	$web_method = $_COOKIE["XJDOV_mothod"];
}
...
//测试模板模式
if(isset($_GET["blog"])){
	setcookie("XJDOV_mothod","2");
	$view='module/m_blog';
}elseif(isset($_GET["gfs"])){
	setcookie("XJDOV_mothod","3");
	$view='module/m_gfs';	
}elseif(isset($_GET["image"])){
	setcookie("XJDOV_mothod","4");
	$view='module/m_image';
}elseif(isset($_GET["zazhi"])){
	setcookie("XJDOV_mothod","1");
	$view='module/m_cms3';
}
